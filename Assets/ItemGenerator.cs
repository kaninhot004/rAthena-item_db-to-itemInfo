...
public class ItemGenerator : MonoBehaviour
{
    ...
    [SerializeField] List<string> allBonus = new List<string>() { "bonus bStr,{n};", "bonus bAgi,{n};", "bonus bVit,{n};", "bonus bInt,{n};", "bonus bDex,{n};", "bonus bLuk,{n};", "bonus bMaxHPrate,{n};", "bonus bMaxSPrate,{n};", "bonus bBaseAtk,{n};", "bonus bAtk2,{n};", "bonus bWeaponAtkRate,{n};", "bonus bMatk,{n};", "bonus bMatkRate,{n};", "bonus bWeaponMatkRate,{n};", "bonus bDef,{n};", "bonus bDefRate,{n};", "bonus bDef2,{n};", "bonus bDef2Rate,{n};", "bonus bMdef,{n};", "bonus bMdefRate,{n};", "bonus bMdef2,{n};", "bonus bMdef2Rate,{n};", "bonus bHit,{n2};", "bonus bHitRate,{n5};", "bonus bCritical,{n};", "bonus bCriticalRate,{n5};", "bonus bFlee,{n2};", "bonus bFleeRate,{n5};", "bonus bPerfectHitAddRate,{n5};", "bonus bSpeedAddRate,{n5};", "bonus bAspd,{n20};", "bonus bAspdRate,{n5};", "bonus bHPrecovRate,{n};", "bonus bSPrecovRate,{n};", "bonus bUseSPrate,-{n10};", "bonus bShortAtkRate,{n2};", "bonus bLongAtkRate,{n2};", "bonus bCritAtkRate,{n2};", "bonus bCritDefRate,{n5};", "bonus bCriticalDef,{n5};", "bonus bNearAtkDef,{n5};", "bonus bLongAtkDef,{n5};", "bonus bMagicAtkDef,{n5};", "bonus bMiscAtkDef,{n5};", "bonus bHealPower,{n};", "bonus bHealPower2,{n};", "bonus bFixedCastrate,-{n5};", "bonus bVariableCastrate,-{n5};", "bonus bFixedCast,-{t2};", "bonus bVariableCast,-{t2};", "bonus bNoCastCancel2;", "bonus bDelayrate,-{n2};", "bonus2 bAddEle,{e},{n};", "bonus2 bMagicAddEle,{e},{n};", "bonus2 bSubEle,{e},{n5};", "bonus2 bAddRace,{r},{n};", "bonus2 bMagicAddRace,{r},{n};", "bonus2 bSubRace,{r},{n5};", "bonus2 bAddClass,{c},{n};", "bonus2 bMagicAddClass,{c},{n};", "bonus2 bSubClass,{c},{n5};", "bonus2 bAddSize,{s},{n};", "bonus2 bMagicAddSize,{s},{n};", "bonus2 bSubSize,{s},{n5};", "bonus2 bMagicSubSize,{s},{n5};", "bonus bNoSizeFix;", "bonus bAtkEle,{e};", "bonus bDefEle,{e};", "bonus2 bMagicAtkEle,{e},{n};", "bonus bDefRatioAtkRace,{r};", "bonus bDefRatioAtkEle,{e};", "bonus bDefRatioAtkClass,{c};", "bonus2 bIgnoreDefRaceRate,{r},{n2};", "bonus2 bIgnoreMdefRaceRate,{r},{n2};", "bonus2 bIgnoreDefClassRate,{c},{n2};", "bonus2 bIgnoreMdefClassRate,{c},{n2};", "bonus2 bExpAddRace,{r},{n};", "bonus2 bExpAddClass,{c},{n};", "bonus2 bAddEff,{eff},{n};", "bonus2 bResEff,{eff},{n};", "bonus bHPDrainValue,{n};", "bonus bSPDrainValue,{n};", "bonus bShortWeaponDamageReturn,{n20};", "bonus bLongWeaponDamageReturn,{n20};", "bonus bMagicDamageReturn,{n20};", "bonus bReduceDamageReturn,{n20};", "bonus bUnstripableWeapon;", "bonus bUnstripableArmor;", "bonus bUnstripableHelm;", "bonus bUnstripableShield;", "bonus bUnstripable;", "bonus bUnbreakable,{n2};", "bonus2 bDropAddRace,{r},{n};", "bonus2 bDropAddClass,{c},{n};", "bonus bDoubleAddRate,{n20};", "bonus bNoKnockback;", "bonus bNoGemStone;", "bonus bIntravision;", "bonus bPerfectHide;", "bonus bNoMadoFuel;", "bonus bNoWalkDelay;" };
