...
public class Converter : MonoBehaviour
{
    ...
    string AllInOneParse(string text)
    {
        ...
        text = text.Replace("JOB_ARCHER", " Archer");
        text = text.Replace("JOB_ACOLYTE", " Acolyte");
        text = text.Replace("JOB_MERCHANT", " Merchant");
        text = text.Replace("JOB_THIEF", " Thief");
        text = text.Replace("JOB_TAEKWON", " Taekwon");
        text = text.Replace("JOB_GUNSLINGER", " Gunslinger");
        text = text.Replace("JOB_NINJA", " Ninja");
        text = text.Replace("JOB_GANGSI", " Gangsi");
        text = text.Replace("JOB_KNIGHT", " Knight");
        text = text.Replace("JOB_WIZARD", " Wizard");
        text = text.Replace("JOB_HUNTER", " Hunter");
        text = text.Replace("JOB_PRIEST", " Priest");
        text = text.Replace("JOB_BLACKSMITH", " Blacksmith");
        text = text.Replace("JOB_ASSASSIN", " Assassin");
        text = text.Replace("JOB_STAR_GLADIATOR", " Star Gladiator");
        text = text.Replace("JOB_STARGLADIATOR", " Star Gladiator");
        text = text.Replace("JOB_REBELLION", " Rebellion");
        text = text.Replace("JOB_KAGEROUOBORO", " Kagerou & Oboro");
        text = text.Replace("JOB_DEATH_KNIGHT", " Death Knight");
        text = text.Replace("JOB_DEATHKNIGHT", " Death Knight");
        text = text.Replace("JOB_CRUSADER", " Crusader");
        text = text.Replace("JOB_SAGE", " Sage");
        text = text.Replace("JOB_BARDDANCER", " Bard & Dancer");
        text = text.Replace("JOB_MONK", " Monk");
        text = text.Replace("JOB_ALCHEMIST", " Alchemist");
        text = text.Replace("JOB_ROGUE", " Rogue");
        text = text.Replace("JOB_SOUL_LINKER", " Soul Linker");
        text = text.Replace("JOB_SOULLINKER", " Soul Linker");
        text = text.Replace("JOB_DARK_COLLECTOR", " Dark Colletor");
        text = text.Replace("JOB_DARKCOLLECTOR", " Dark Colletor");
        text = text.Replace("JOB_NOVICE_HIGH", " High Novice");
        text = text.Replace("JOB_SWORDMAN_HIGH", " High Swordman");
        text = text.Replace("JOB_MAGE_HIGH", " High Mage");
        text = text.Replace("JOB_ARCHER_HIGH", " High Archer");
        text = text.Replace("JOB_ACOLYTE_HIGH", " High Acolyte");
        text = text.Replace("JOB_MERCHANT_HIGH", " High Merchant");
        text = text.Replace("JOB_THIEF_HIGH", " High Thief");
        text = text.Replace("JOB_LORD_KNIGHT", " Lord Knight");
        text = text.Replace("JOB_HIGH_WIZARD", " High Wizard");
        text = text.Replace("JOB_SNIPER", " Sniper");
        text = text.Replace("JOB_HIGH_PRIEST", " High Priest");
        text = text.Replace("JOB_WHITESMITH", " Whitesmith");
        text = text.Replace("JOB_ASSASSIN_CROSS", " Assassin Cross");
        text = text.Replace("JOB_PALADIN", " Paladin");
        text = text.Replace("JOB_PROFESSOR", " Professor");
        text = text.Replace("JOB_CLOWNGYPSY", " Clown & Gypsy");
        text = text.Replace("JOB_CHAMPION", " Champion");
        text = text.Replace("JOB_CREATOR", " Creator");
        text = text.Replace("JOB_STALKER", " Stalker");
        text = text.Replace("JOB_BABY", " Baby");
        text = text.Replace("JOB_BABY_SWORDMAN", " Baby Swordman");
        text = text.Replace("JOB_BABY_MAGE", " Baby Mage");
        text = text.Replace("JOB_BABY_ARCHER", " Baby Archer");
        text = text.Replace("JOB_BABY_ACOLYTE", " Baby Acolyte");
        text = text.Replace("JOB_BABY_MERCHANT", " Baby Merchant");
        text = text.Replace("JOB_BABY_THIEF", " Baby Thief");
        text = text.Replace("JOB_BABY_TAEKWON", " Baby Taekwon");
        text = text.Replace("JOB_BABY_GUNSLINGER", " Baby Gunslinger");
        text = text.Replace("JOB_BABY_NINJA", " Baby Ninja");
        text = text.Replace("JOB_BABY_SUMMONER", " Baby Summoner");
        text = text.Replace("JOB_BABY_KNIGHT", " Baby Knight");
        text = text.Replace("JOB_BABY_WIZARD", " Baby Wizard");
        text = text.Replace("JOB_BABY_HUNTER", " Baby Hunter");
        text = text.Replace("JOB_BABY_PRIEST", " Baby Priest");
        text = text.Replace("JOB_BABY_BLACKSMITH", " Baby Blacksmith");
        text = text.Replace("JOB_BABY_ASSASSIN", " Baby Assassin");
        text = text.Replace("JOB_BABY_STAR_GLADIATOR", " Baby Star Gladiator");
        text = text.Replace("JOB_BABY_REBELLION", " Baby Rebellion");
        text = text.Replace("JOB_BABY_KAGEROUOBORO", " Baby Kagerou & Baby Oboro");
        text = text.Replace("JOB_BABY_CRUSADER", " Baby Crusader");
        text = text.Replace("JOB_BABY_SAGE", " Baby Sage");
        text = text.Replace("JOB_BABY_BARDDANCER", " Baby Bard & Baby Dancer");
        text = text.Replace("JOB_BABY_MONK", " Baby Monk");
        text = text.Replace("JOB_BABY_ALCHEMIST", " Baby Alchemist");
        text = text.Replace("JOB_BABY_ROGUE", " Baby Rouge");
        text = text.Replace("JOB_BABY_SOUL_LINKER", " Baby Soul Linker");
        text = text.Replace("JOB_RUNE_KNIGHT", " Rune Knight");
        text = text.Replace("JOB_WARLOCK", " Warlock");
        text = text.Replace("JOB_RANGER", " Ranger");
        text = text.Replace("JOB_ARCH_BISHOP", " Arch Bishop");
        text = text.Replace("JOB_MECHANIC", " Mechanic");
        text = text.Replace("JOB_GUILLOTINE_CROSS", " Guillotine Cross");
        text = text.Replace("JOB_STAR_EMPEROR", " Star Emperor");
        text = text.Replace("JOB_ROYAL_GUARD", " Royal Guard");
        text = text.Replace("JOB_SORCERER", " Sorcerer");
        text = text.Replace("JOB_MINSTRELWANDERER", " Minstrel & Wanderer");
        text = text.Replace("JOB_SURA", " Sura");
        text = text.Replace("JOB_GENETIC", " Genetic");
        text = text.Replace("JOB_SHADOW_CHASER", " Shadow Chaser");
        text = text.Replace("JOB_SOUL_REAPER", " Soul Reaper");
        text = text.Replace("JOB_RUNE_KNIGHT_T", " Rune Knight T.");
        text = text.Replace("JOB_WARLOCK_T", " Warlock T.");
        text = text.Replace("JOB_RANGER_T", " Ranger T.");
        text = text.Replace("JOB_ARCH_BISHOP_T", " Arch Bishop T.");
        text = text.Replace("JOB_MECHANIC_T", " Mechanic T.");
        text = text.Replace("JOB_GUILLOTINE_CROSS_T", " Guilootine Cross T.");
        text = text.Replace("JOB_ROYAL_GUARD_T", " Royal Guard T.");
        text = text.Replace("JOB_SORCERER_T", " Sorcerer T.");
        text = text.Replace("JOB_MINSTRELWANDERER_T", " Minstrel T. & Wanderer T.");
        text = text.Replace("JOB_SURA_T", " Sura T.");
        text = text.Replace("JOB_GENETIC_T", " Genetic T.");
        text = text.Replace("JOB_SHADOW_CHASER_T", " Shadow Chaser T.");
        text = text.Replace("JOB_BABY_RUNE", " Baby Rune Knight");
        text = text.Replace("JOB_BABY_RUNE_KNIGHT", " Baby Rune Knight");
        text = text.Replace("JOB_BABY_CROSS", " Baby Guillotine Cross");
        text = text.Replace("JOB_BABY_GUILLOTINE_CROSS", " Baby Guillotine Cross");
        text = text.Replace("JOB_BABY_BISHOP", " Baby Arch Bishop");
        text = text.Replace("JOB_BABY_ARCH_BISHOP", " Baby Arch Bishop");
        text = text.Replace("JOB_BABY_GUARD", " Baby Royal Guard");
        text = text.Replace("JOB_BABY_ROYAL_GUARD", " Baby Royal Guard");
        text = text.Replace("JOB_BABY_CHASER", " Baby Shadow Chaser");
        text = text.Replace("JOB_BABY_SHADOW_CHASER", " Baby Shadow Chaser");
        text = text.Replace("JOB_BABY_RUNE_KNIGHT", " Baby Rune Knight");
        text = text.Replace("JOB_BABY_WARLOCK", " Baby Warlock");
        text = text.Replace("JOB_BABY_RANGER", " Baby Ranger");
        text = text.Replace("JOB_BABY_ARCH_BISHOP", " Baby Arch Bishop");
        text = text.Replace("JOB_BABY_MECHANIC", " Baby Mechanic");
        text = text.Replace("JOB_BABY_GUILLOTINE_CROSS", " Baby Guillotine Cross");
        text = text.Replace("JOB_BABY_STAR_EMPEROR", " Baby Star Emperor");
        text = text.Replace("JOB_BABY_ROYAL_GUARD", " Baby Royal Guard");
        text = text.Replace("JOB_BABY_SORCERER", " Baby Sorcerer");
        text = text.Replace("JOB_BABY_MINSTRELWANDERER", " Baby Minstrel & Baby Wanderer");
        text = text.Replace("JOB_BABY_SURA", " Baby Sura");
        text = text.Replace("JOB_BABY_GENETIC", " Baby Genetic");
        text = text.Replace("JOB_BABY_SHADOW_CHASER", " Baby Shadow Chaser");
        text = text.Replace("JOB_BABY_SOUL_REAPER", " Baby Soul Reaper");
        text = text.Replace("JOB_SUPER_NOVICE", " Super Novice");
        text = text.Replace("JOB_SUPERNOVICE", " Super Novice");
        text = text.Replace("JOB_SUPER_BABY", " Super Baby");
        text = text.Replace("JOB_SUPER_NOVICE_E", " Expanded Super Novice");
        text = text.Replace("JOB_SUPER_BABY_E", " Expanded Super Baby");
        text = text.Replace("JOB_SUMMONER", " Summoner");
        text = text.Replace("JOB_SPIRIT_HANDLER", " Spirit Handler");
        text = text.Replace("JOB_HYPER_NOVICE", " Hyper Novice");
        text = text.Replace("JOB_DRAGON_KNIGHT", " Dragon Knight");
        text = text.Replace("JOB_ARCH_MAGE", " Arch Mage");
        text = text.Replace("JOB_WINDHAWK", " Windhawk");
        text = text.Replace("JOB_CARDINAL", " Cardinal");
        text = text.Replace("JOB_MEISTER", " Meister");
        text = text.Replace("JOB_SHADOW_CROSS", " Shadow Cross");
        text = text.Replace("JOB_SKY_EMPEROR", " Sky Emperor");
        text = text.Replace("JOB_NIGHT_WATCH", " Night Watch");
        text = text.Replace("JOB_SHINKIRO_SHIRANUI", " Shinkiro & Shiranui");
        text = text.Replace("JOB_IMPERIAL_GUARD", " Imperial Guard");
        text = text.Replace("JOB_ELEMENTAL_MASTER", " Elemental Master");
        text = text.Replace("JOB_TROUBADOURTROUVERE", " Troubador & Trouvere");
        text = text.Replace("JOB_INQUISITOR", " Inquisitor");
